...
export function HippoTimeline() {
    const timelineData = [
        { date: '16 April 2026', title: 'REGISTRATION', subtitle: "Mexico", description: 'The final day to register for HIPPO.' },
        { date: '17 & 18 April 2026', title: 'PRELIMINARY ROUNDS', subtitle: "Mexico", description: 'The first step of the Hippo journey — your first test, right near home, maybe even in your own school! Also available online.' },
        { date: '8 & 9 May 2026', title: 'NATIONAL FINALS', subtitle: "Mexico", description: 'Only the top 20% make it here — the best of the best competing in major cities across the country or online!' },
